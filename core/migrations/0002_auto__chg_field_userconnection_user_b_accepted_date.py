...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserConnection.user_b_accepted_date'
        db.alter_column(u'core_userconnection', 'user_b_accepted_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserConnection.user_b_accepted_date'
        db.alter_column(u'core_userconnection', 'user_b_accepted_date', self.gf('django.db.models.fields.DateTimeField')(default=''))
